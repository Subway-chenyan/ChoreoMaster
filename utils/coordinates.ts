...
export function mapTo3D(
  ...
  // In 3D: +z is front (towards camera at z=20), -z is back (away from camera)
  // Front of stage (y=100 in 2D) should map to positive z (towards camera)
  // Back of stage (y=0 in 2D) should map to negative z (away from camera)
